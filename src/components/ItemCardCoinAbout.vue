<template>
    <li><div class="tablet:h-[230px] mb-5 shadow-sm bg-white rounded-xl flex flex-col items-center tablet:flex-row-reverse justify-between p-3">
        ...
        <div class="flex flex-col  child:text-center tablet:child:text-left mt-2 tablet:mt-0  laptop:mr-5">
          <h3 class="font-[600] text-xl">Leveraged tokens now available</h3>
          <p class="text-slate-400 py-2 tablet:py-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore, vel?</p>
          <span class="text-slate-400">jun 1,2021</span>
        </div>
      </div></li>
</template>
